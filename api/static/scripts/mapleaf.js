...
const airplane = L.icon({
  iconUrl: './api/static/images/airplane_1.png',
...
const airplaneSel = L.icon({
  iconUrl: './api/static/images/airplane_sel.png',
  iconSize: [30, 30], // size of the icon
  iconAnchor: [15, 15], // point of the icon which will correspond to marker's location
  popupAnchor: [-2, -10], // point from which the popup should open relative to the iconAnchor
...
const airplaneRed = L.icon({
  iconUrl: './api/static/images/airplane_red.png',
  iconSize: [30, 30], // size of the icon
  iconAnchor: [15, 15], // point of the icon which will correspond to marker's location
  popupAnchor: [-2, -10] // point from which the popup should open relative to the iconAnchor
});
...
function getPlanes() {
  const json = $.getJSON('http://15.228.45.138:5000/api/flights', function (index) {
